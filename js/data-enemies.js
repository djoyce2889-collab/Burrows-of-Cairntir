...
theUnyieldingFlame: {
  ...
  highlandFellWolf: {
    id: "highlandFellWolf",
    name: "Highland Fell-Wolf",
    description: "A massive wolf built for the coldest, harshest ground the Highlands have to offer, running down anything smaller without hesitation.",
    image: "assets/images/enemies/highland-fell-wolf.png",
    hitPoints: 36,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  moonriseWerewolf: {
    id: "moonriseWerewolf",
    name: "Moonrise Werewolf",
    description: "Fully transformed, fully feral, and utterly indifferent to whatever it was before tonight.",
    image: "assets/images/enemies/moonrise-werewolf.png",
    hitPoints: 40,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  brambleFangedLoper: {
    id: "brambleFangedLoper",
    name: "Bramble-Fanged Loper",
    description: "Lean, fast, and built to hunt through the thickest heather without ever slowing down.",
    image: "assets/images/enemies/bramble-fanged-loper.png",
    hitPoints: 32,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  frostCursedWerewolf: {
    id: "frostCursedWerewolf",
    name: "Frost-Cursed Werewolf",
    description: "Fully transformed, frost clinging to matted fur that never seems to thaw, even mid-hunt.",
    image: "assets/images/enemies/frost-cursed-werewolf.png",
    hitPoints: 42,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  bloodHowlAlpha: {
    id: "bloodHowlAlpha",
    name: "Blood-Howl Alpha",
    description: "Larger than any wolf around it, and every other wolf on this mountain knows exactly why it leads.",
    image: "assets/images/enemies/blood-howl-alpha.png",
    hitPoints: 44,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  theBloodJarl: {
    id: "theBloodJarl",
    name: "The Blood-Jarl",
    description: "Ruled once as a real Norse warlord. Whatever he became after death has never once relinquished that command.",
    image: "assets/images/enemies/the-blood-jarl.png",
    hitPoints: 42,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  draugrFangedReaver: {
    id: "draugrFangedReaver",
    name: "Draugr-Fanged Reaver",
    description: "A draugr warrior long past simple undeath, its hunger having curdled into something that drinks rather than merely kills.",
    image: "assets/images/enemies/draugr-fanged-reaver.png",
    hitPoints: 38,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  thePaleSkald: {
    id: "thePaleSkald",
    name: "The Pale Skald",
    description: "Once sang for chieftains and kings. Still sings, if you get close enough to hear it — by then, it's usually too late.",
    image: "assets/images/enemies/the-pale-skald.png",
    hitPoints: 36,
    attackType: "magic",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  runeMarkedBloodkin: {
    id: "runeMarkedBloodkin",
    name: "Rune-Marked Bloodkin",
    description: "Bound and empowered by rune-magic gone dark generations ago, stronger for it in every way that matters.",
    image: "assets/images/enemies/rune-marked-bloodkin.png",
    hitPoints: 40,
    attackType: "magic",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  theIceVeiledShieldmaiden: {
    id: "theIceVeiledShieldmaiden",
    name: "The Ice-Veiled Shieldmaiden",
    description: "Still carries herself with a warrior's discipline, even now. Death never once took that from her.",
    image: "assets/images/enemies/the-ice-veiled-shieldmaiden.png",
    hitPoints: 42,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  barkSkinnedWretch: {
    id: "barkSkinnedWretch",
    name: "Bark-Skinned Wretch",
    description: "Corrupted and shambling, more animal instinct left in it now than whatever it used to be.",
    image: "assets/images/enemies/bark-skinned-wretch.png",
    hitPoints: 36,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  thornboundStalker: {
    id: "thornboundStalker",
    name: "Thornbound Stalker",
    description: "Fast and thorn-covered, moving through the densest undergrowth without once slowing down.",
    image: "assets/images/enemies/thornbound-stalker.png",
    hitPoints: 34,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  mossGrownEnt: {
    id: "mossGrownEnt",
    name: "Moss-Grown Ent",
    description: "Hulking, ancient, and slow — right up until the moment it isn't.",
    image: "assets/images/enemies/moss-grown-ent.png",
    hitPoints: 46,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  hollowBarkedWanderer: {
    id: "hollowBarkedWanderer",
    name: "Hollow-Barked Wanderer",
    description: "Shuffles forward endlessly, hollowed out at the core, driven by nothing anyone's ever managed to explain.",
    image: "assets/images/enemies/hollow-barked-wanderer.png",
    hitPoints: 38,
    attackType: "physical",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  vineChokedSentinel: {
    id: "vineChokedSentinel",
    name: "Vine-Choked Sentinel",
    description: "Bound and twisted by strangling vines that grew into it rather than around it, guarding ground it's long forgotten why it guards.",
    image: "assets/images/enemies/vine-choked-sentinel.png",
    hitPoints: 40,
    attackType: "magic",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  nightStripedLeopardHunt: {
    id: "nightStripedLeopardHunt",
    name: "Night-Striped Leopard",
    description: "Moves without sound through undergrowth that should be loud enough to give anything away.",
    image: "assets/images/enemies/night-striped-leopard.png",
    hitPoints: 42,
    attackType: "physical",
    threatTier: "Master",
    soundCategory: "physical",
  ...
  giantJungleAntHunt: {
    id: "giantJungleAntHunt",
    name: "Giant Jungle Ant",
    description: "Mandibles alone the size of a forearm, carapace cracked and weeping something dark.",
    image: "assets/images/enemies/giant-jungle-ant.png",
    hitPoints: 40,
    attackType: "physical",
    threatTier: "Master",
    soundCategory: "physical",
  ...
  savannaRhinoBeast: {
    id: "savannaRhinoBeast",
    name: "Savanna Rhino-Beast",
    description: "Massive, aggressive, and utterly committed once it starts charging — nothing about stopping halfway.",
    image: "assets/images/enemies/savanna-rhino-beast.png",
    hitPoints: 46,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  tuskedGroveBreaker: {
    id: "tuskedGroveBreaker",
    name: "Tusked Grove-Breaker",
    description: "A corrupted elephant, massive and enraged, tearing straight through anything unlucky enough to be in its path.",
    image: "assets/images/enemies/tusked-grove-breaker.png",
    hitPoints: 48,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
  ...
  venomStripedHyena: {
    id: "venomStripedHyena",
    name: "Venom-Striped Hyena",
    description: "Larger and far more aggressive than any ordinary hyena, its bite carrying something that lingers long after the wound closes.",
    image: "assets/images/enemies/venom-striped-hyena.png",
    hitPoints: 38,
    attackType: "magic",
    threatTier: "Adept",
    soundCategory: "physical",
  ...
  youngDragonHunt: {
    id: "youngDragonHunt",
    name: "Young Dragon",
    description: "Massive and terrifying, scales in deep crimsons and golds, eyes glowing with hunger and ancient intelligence.",
    image: "assets/images/enemies/young-dragon-hunt.png",
    hitPoints: 44,
    attackType: "magic",
    threatTier: "Master",
    soundCategory: "fire",
  ...
  wyvernHunt: {
    id: "wyvernHunt",
    name: "Wyvern",
    description: "A two-legged draconic creature, wings half-spread and ready, serpentine tail coiled.",
    image: "assets/images/enemies/wyvern-hunt.png",
    hitPoints: 40,
    attackType: "physical",
    threatTier: "Master",
    soundCategory: "physical",
  ...
  fireDrakeHunt: {
    id: "fireDrakeHunt",
    name: "Fire Drake",
    description: "Scaled body in deep crimsons and golds, wisps of smoke and embers trailing from its nostrils.",
    image: "assets/images/enemies/fire-drake-hunt.png",
    hitPoints: 42,
    attackType: "magic",
    threatTier: "Master",
    soundCategory: "fire",
  ...
  deepCoiledLeviathan: {
    id: "deepCoiledLeviathan",
    name: "Deep-Coiled Leviathan",
    description: "A massive, ancient sea-serpent, surfacing from the darkest water this side of the mountains.",
    image: "assets/images/enemies/deep-coiled-leviathan.png",
    hitPoints: 46,
    attackType: "physical",
    threatTier: "Master",
    soundCategory: "physical",
  ...
  fjordSerpentHunt: {
    id: "fjordSerpentHunt",
    name: "Fjord Serpent",
    description: "A genuine sea-serpent hunting the cold coastal waters, fast and utterly without warning.",
    image: "assets/images/enemies/fjord-serpent.png",
    hitPoints: 40,
    attackType: "physical",
    threatTier: "Expert",
    soundCategory: "physical",
